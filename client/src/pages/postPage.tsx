        ...
        <div className="container-xl">
          <div className="lg:flex justify-around">
            <div className="content ">
              <img src={`http://localhost:4000/${postInfo.cover}`} alt="post-image" className='h-[300px] w-[100%] mb-5 object-cover' />
                  ...
                  {userInfo.id === postInfo.author._id && (
                    <>
                      <div className="edit-row">
                        <Link className="edit-btn flex items-center gap-1 hover:text-white" to={`/edit/${postInfo._id}`}>
